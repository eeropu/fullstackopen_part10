...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
        it('renders repository information correctly', () => {
            ...
            expect(getByTestId('jaredpalmer.formik:stars')).toHaveTextContent('Stars');
            expect(getByTestId('jaredpalmer.formik:forksCount')).toHaveTextContent('1.6k');
            expect(getByTestId('jaredpalmer.formik:forks')).toHaveTextContent('Forks');
            expect(getByTestId('jaredpalmer.formik:reviewCount')).toHaveTextContent('3');
            expect(getByTestId('jaredpalmer.formik:reviews')).toHaveTextContent('Reviews');
            expect(getByTestId('jaredpalmer.formik:ratingAverage')).toHaveTextContent('88');
            expect(getByTestId('jaredpalmer.formik:rating')).toHaveTextContent('Rating');
            ...
            expect(getByTestId('async-library.react-async:stars')).toHaveTextContent('Stars');
            expect(getByTestId('async-library.react-async:forksCount')).toHaveTextContent('69');
            expect(getByTestId('async-library.react-async:forks')).toHaveTextContent('Forks');
            expect(getByTestId('async-library.react-async:reviewCount')).toHaveTextContent('3');
            expect(getByTestId('async-library.react-async:reviews')).toHaveTextContent('Reviews');
            expect(getByTestId('async-library.react-async:ratingAverage')).toHaveTextContent('72');
            expect(getByTestId('async-library.react-async:rating')).toHaveTextContent('Rating');
        });
    });
});